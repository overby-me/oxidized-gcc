...
impl Lexer {
    ...
    /// Format: __rustgcc_pack_set_N, __rustgcc_pack_push_N, __rustgcc_pack_push_only,
    ///         __rustgcc_pack_pop, __rustgcc_pack_reset
    fn try_pragma_pack_token(text: &str) -> Option<TokenKind> {
        if let Some(rest) = text.strip_prefix("__rustgcc_pack_") {
            if rest == "pop" {
    ...
    /// Format: __rustgcc_visibility_push_VISIBILITY, __rustgcc_visibility_pop
    fn try_pragma_visibility_token(text: &str) -> Option<TokenKind> {
        if let Some(rest) = text.strip_prefix("__rustgcc_visibility_") {
            if rest == "pop" {
