...
pub(super) fn emit_shared_library(
    ...
    let mut sections_with_abs_relocs: std::collections::HashSet<usize> =
    ...
    let total_rela_count =
        relative_count + glob_dat_entries.len() + tpoff64_entries.len() + abs64_entries.len();
