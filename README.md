...
> [`safety/oxidized/gcc`](https://tangled.org/overby.me/overby.me/tree/main/rust/gcc) and where all development happens.
>
> It is also published on its own, as
> [tangled.org/overby.me/rust-gcc](https://tangled.org/overby.me/rust-gcc) and
> [github.com/overby-me/rust-gcc](https://github.com/overby-me/rust-gcc). Both
